# Oefening 9.1 - Een volledige ML-pipeline bouwen
...
Ruwe data via preprocessing en modellering reproduceerbaar verwerken.

## Opdracht

Maak een kleine dataset, splits deze in train en test, gebruik een Pipeline met StandardScaler en LogisticRegression en rapporteer de testscore.
